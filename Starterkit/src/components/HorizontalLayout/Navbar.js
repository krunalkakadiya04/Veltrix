                ...
                <li className="nav-item dropdown mega-dropdown">
                  ...
                  >
                    <Row>
                      <Col lg={4}>
                        <div>
                          <Link to="/AddInquiry" className="dropdown-item">
                            {props.t("New Inquiry")}
                          </Link>
                          <Link to="/Inquiry_Status" className="dropdown-item">
                            {props.t("Check Inquiry Status")}
                          </Link>
                        </div>
                      </Col>
                      <Col lg={4}>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <div className="dropdown">
                      ...
                      >
                        {props.t("All Data")} <div className="arrow-down"></div>
                      </Link>
                      <div
                        className={classname("dropdown-menu", { show: email })}
                      >
                        <Link to="/Inquiry_Details" className="dropdown-item">
                          {props.t("Active Inquiry")}{" "}
                        </Link>
                        <Link to="/Inquiry_Details" className="dropdown-item">
                          {props.t("Solved Inquiry")}
                        </Link>
                        <Link to="/Inquiry_Details" className="dropdown-item">
                          {props.t("Unsolved Inquiry")}
                        </Link>
                      </div>
